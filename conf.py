...
# ABD build configuration file, created by
# `ablog start` on Sat Jul 20 17:19:28 2024.
#
...
blog_authors = {
    "Muhammed Abdullah": ("Muhammed Abdullah", None),
}
...
# disqus_shortname = 'muhammed_disqus'
...
sys.path.append(osp.abspath('exts/ablog/src'))
...
# pixels large.
html_favicon = "old/assets/img/icon/favicon.ico"
...
# from postlist import Postlist, DummyPostlist
# def setup(app):
#     app.add_directive("postlist", Postlist)
#     return {
#         'version': '0.1',
